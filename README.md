...
An interactive plot of the position, velocity and acceleration based on different parameters can be found here : [https://www.desmos.com/calculator/psaqir52bc](https://www.desmos.com/calculator/mwyycjhe5f)
